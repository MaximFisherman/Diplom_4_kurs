...
echo("<input type='button' value='<- повернутись до головного вікна' class='btn btn-warning' onclick='exit_file_menu();'>")
?>
...
{
	document.location.replace("../User_start_page_fines.html");
}
</script>
   </body>
</html>