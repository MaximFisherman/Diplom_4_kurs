            ...
            while($arr = mysql_fetch_array($res)) {
                ...
                echo(" 
                                    ...
                                    <td align=\"center\">
                                        ...
                                        <a href=\"php/View_news_article.php1?path_photo=".$arr["Path_photo"]."&&file='view'&&id_news=".$arr['id_news']."&&description_news=".$arr["Description"]."&&name_news=". $arr["Name"]."&&title_news=". $arr["Article"]."\" class=\"btn btn-warning\" title=\"Прочитати\"><i class=\"glyphicon glyphicon-folder-open\"></i></a>
